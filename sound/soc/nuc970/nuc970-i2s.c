...
#if defined(CONFIG_OF)
static const struct of_device_id nuc970_audio_i2s_of_match[] = {
	{   .compatible = "nuvoton,nuc970-audio-i2s"    },
	{   },
};
MODULE_DEVICE_TABLE(of, nuc970_audio_i2s_of_match);
#endif
...
static struct platform_driver nuc970_i2s_driver = {
		.driver = {
			...
			.owner  = THIS_MODULE,
#if defined(CONFIG_OF)
			.of_match_table = of_match_ptr(nuc970_audio_i2s_of_match),
#endif
		},
