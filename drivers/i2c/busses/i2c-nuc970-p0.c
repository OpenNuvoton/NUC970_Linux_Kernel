...
/* nuc970_i2c0_master_complete
 *
 * complete the message and wake up the caller, using the given return code,
 * or zero to mean ok.
*/

static inline void nuc970_i2c0_master_complete(struct nuc970_i2c *i2c, int ret)
{
...
static inline void nuc970_i2c0_disable_irq(struct nuc970_i2c *i2c)
{
	unsigned long tmp;
...
static inline void nuc970_i2c0_enable_irq(struct nuc970_i2c *i2c)
{
	unsigned long tmp;
...
static inline void nuc970_i2c0_stop(struct nuc970_i2c *i2c, int ret)
{
	...
	nuc970_i2c0_master_complete(i2c, ret);
}
...
retry_write:
		...
		if (!is_msgend(i2c)) {
			...
			if (i2c->msg->flags & I2C_M_NOSTART) {
				...
				/* send the new start */
				nuc970_i2c0_message_start(i2c, i2c->msg);
...
*/
static void nuc970_i2c0_hangup(struct nuc970_i2c *i2c)
{
	int i;
...
/* nuc970_i2c0_set_master
 *
 * get the i2c bus for a master transaction
*/

static int nuc970_i2c0_set_master(struct nuc970_i2c *i2c)
{
	int timeout = 400;
			...
			struct i2c_msg *msgs, int num)
{
	...
	nuc970_i2c0_enable_irq(i2c);

	for (retry = 0; retry < adap->retries; retry++) {

		ret = nuc970_i2c0_doxfer(i2c, msgs, num);
...
#if defined(CONFIG_OF)
static const struct of_device_id nuc970_i2c0_of_match[] = {
	{   .compatible = "nuvoton,nuc970-i2c0" },
	{	},
};
MODULE_DEVICE_TABLE(of, nuc970_i2c0_of_match);
#endif
